...
const addPost =  async (location, description, postedTime,updatedTime,imageID,status,jobType) => {

  const postCollection = await posts();
  var currentdate = new Date(); 
  var postedTime =  (currentdate.getMonth()+1)+ "/"+currentdate.getDate()   + "/" + currentdate.getFullYear() + " / "  +  currentdate.toLocaleTimeString();
  var updatedTime = currentdate.getDate() + "/"+ (currentdate.getMonth()+1)  + "/" + currentdate.getFullYear() + " / "  +  currentdate.toLocaleTimeString();

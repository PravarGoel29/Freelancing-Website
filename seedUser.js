...
async function main() {
    ...
    try {
        let user1 = await users.createUser('user1', 'thiru', 'naa', 'thiru@gmail.com', 'Password@123', '4235687123', 'male',
            '1995-12-12', 'Programming and Tech')

        // setting a five second delay between user creation to ensure we don't send verification emails in quick succession
        await new Promise(r => setTimeout(r, 5000));

        let user2 = await users.createUser('user2', 'jesh', 'wanth', 'test8@gmail.com', 'Password@123', '5513581851', 'male',
            '1999-01-12', 'Sales')
